...
class LoadingPageBloc extends Bloc<LoadingPageEvent, LoadingPageState> {
  LoadingPageBloc({required final LoadingPageRepository loadingPageRepository})
      : _loadingPageRepository = loadingPageRepository,
        super(LoadingPageState()) {
    on<LoadingPageEventInit>(_init);
  }

  final LoadingPageRepository _loadingPageRepository;

  Future<void> _init(
      LoadingPageEventInit event, Emitter<LoadingPageState> emit) async {\
